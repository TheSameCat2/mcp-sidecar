...
print("Waiting for clangd (8s)...")
time.sleep(8)

# Test symbol_refs on LogStack::clearLog (line 301)
print("\n=== Testing symbol_refs on LogStack.cpp:301:20 ===")
send({"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"symbol_refs","arguments":{"file":"Applications/AppLibraries/LogList/LogList/LogStack.cpp","line":301,"column":20}}})
resp = recv()
